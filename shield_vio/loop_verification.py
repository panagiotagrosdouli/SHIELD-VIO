...
def verify_loop_candidate(
    ...
    *,
    ...
    ``translation_scale_m`` must come from an independent metric source such as
    inertial propagation, stereo, depth, or an existing pose estimate. The
    essential-matrix translation itself remains scale-free.
    """
