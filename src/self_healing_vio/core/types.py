...
Keeping common research concepts in one module avoids stringly typed APIs and
prevents circular dependencies between health, diagnosis, and recovery modules.
"""
...
class RecoveryAction(str, Enum):
    ...
    The legacy recovery module still exports its own enum for compatibility, but
    new research code should prefer this shared definition.
    """
